...
my_string = "ABCDEFGHI" # string o cadena de carecteres
...
print(my_string[1:5]) # Los dos puntos es como decir "desde, hasta", pero el último elemento que pono en este caso 4 no será ese el último porque es exclusivo, entonces llegará hasta el tercero
